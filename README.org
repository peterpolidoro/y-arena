...
** Matlab
   ...
   #+BEGIN_SRC matlab
     ...
     arenaValvesOpenMsg.arena = uint8(0)
     arenaValvesOpenMsg.valves = uint8([0 2 1])
...
** Linux Command Line Using Docker
   ...
   #+BEGIN_SRC sh
     docker build -t y_arena_valve_controller:latest ./software/y_arena_valve_controller_ros/
     ...
     ros2 topic pub --once /arena_valves_open y_arena_interfaces/msg/ArenaValves "{arena: 0, valves: [0, 2, 1]}"
   #+END_SRC
